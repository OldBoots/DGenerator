...
public:
    ...
    const ColumnConfig& getConfig() const;
    size_t getCountRows();
    double getDuplicate();
...
public:
    GenInt();
    GenInt(int min, int max, size_t countRows, double duplicates, bool flgShuffle, bool flgDebug);
    GenInt(int min, int max, size_t countRows, bool flgShuffle, bool flgDebug);
    GenInt(int start, int step, size_t countRows, bool flgDebug);
...
public:
    GenFloat();
    GenFloat(double min, double max, size_t countRows, double duplicates, bool flgShuffle, bool flgDebug);
    GenFloat(double min, double max, size_t countRows, bool flgShuffle, bool flgDebug);
    GenFloat(double start, double step, size_t countRows, bool flgDebug);
    const std::vector<std::string>& genRows() override;
...
public:
    GenWord();
    GenWord(size_t minLength, size_t maxLength, size_t countRows, double duplicates, double capitalLetter, bool m_flgUpperCase, bool flgShuffle, bool flgDebug);
    GenWord(size_t minLength, size_t maxLength, size_t countRows, double capitalLetter, bool m_flgUpperCase, bool flgShuffle, bool flgDebug);
...
public:
    ...
    GenDateTime();
    GenDateTime(size_t countRows, DateFormat format, std::string begin, std::string end, double duplicates, bool flgShuffle, bool flgDebug);
    GenDateTime(size_t countRows, DateFormat format, std::string begin, std::string end, bool flgShuffle, bool flgDebug);
    GenDateTime(size_t countRows, DateFormat format, std::string begin, std::chrono::seconds step, bool flgDebug);
...
public:
    GenString();
    GenString(size_t countRows, double duplicates, bool flgShuffle, bool flgDebug);
    GenString(size_t countRows, bool flgShuffle, bool flgDebug);
    GenString(size_t countRows, bool flgDebug);
